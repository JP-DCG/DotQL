...
namespace Ancestry.QueryProcessor.Parse
{
    /*
		HEADER:
		The following non terminals in the Lexer BNF:
			<identifier>
			<literal>
			<string>
	...
	public class Parser
	{
		/*
			...
			<script> ::=
				<statement>{; <statement>}
		*/
		public Batch ParseScript(string AInput)
		{
        ...
        */        
		...
		public BaseType ParseTypeSpecifier(string input)
		{
			Lexer lexer = new Lexer(input);
			try
			{
				return ParseTypeSpecifier(lexer);
			}
			catch (Exception E)
			{
		...
		protected BaseType ParseTypeSpecifier(Lexer lexer)
		{
