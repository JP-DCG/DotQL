...
namespace Ancestry.QueryProcessor.Parse
{
	...
	/// </remarks>
	public class LanguageException : QPException
	{
		public enum Codes : int
		{
			...
			/// <summary>Error code 107198: "Ancestry exception: {0}"</summary>
			AncestryException = 107198,
		...
		public LanguageException(ErrorSeverity severity, int code, string message, string details, string serverContext, AncestryException innerException) 
