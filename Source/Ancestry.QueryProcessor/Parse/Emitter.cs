...
{
	public class DotQLTextEmitter : BasicTextEmitter
	{
		...
		//{
		//	if (expression.Operator == Operator.IsNull)
		//	{
		//		EmitExpression(expression.Expression);
		//		AppendFormat(" {0}", " is null");
		//	}
		//	else if (expression.Operator == Operator.IsNotNull)
		//	{
		//		EmitExpression(expression.Expression);
		...
		//protected override string GetOperatorKeyword(Operator op)
		//{
		//	if (op == Operator.Concat)
		//		return "||";
		//	else
		//		return base.GetOperatorKeyword(op);
		//}
