...
{
	public class BaseException : AncestryException
	{
		...
		private static ResourceManager _resourceManager = new ResourceManager("Ancestry.QueryProcessor.BaseException", typeof(BaseException).Assembly);
		...
		public BaseException(ErrorSeverity severity, int code, string message, string details, string serverContext, AncestryException innerException) 
